...
colors  = [r.kBlue+2, r.kRed+2,r.kOrange+10,r.kYellow+2,r.kGreen-1,r.kAzure-2,r.kGreen-8,r.kOrange+3,r.kYellow+2,r.kRed+2,r.kBlue+2,r.kGreen-8,r.kOrange+3,r.kYellow+2,r.kRed+2,r.kBlue+2,r.kGreen-8,r.kOrange+3,r.kYellow+2,r.kRed+2,r.kBlue+2,r.kGreen-8,r.kOrange+3,r.kYellow+2,r.kRed+2,r.kBlue+2,r.kGreen-8,r.kOrange+3]
markers = [r.kFullCircle,r.kFullTriangleUp,r.kOpenCircle,r.kOpenTriangleUp,r.kOpenTriangleUp,r.kOpenCircle,r.kFullCircle,r.kOpenSquare,r.kFullSquare,r.kOpenTriangleUp,r.kOpenCircle,r.kFullCircle,r.kOpenSquare,r.kFullSquare,r.kOpenTriangleUp,r.kOpenCircle,r.kFullCircle,r.kOpenSquare,r.kFullSquare,r.kOpenTriangleUp,r.kOpenCircle,r.kFullCircle,r.kOpenSquare,r.kFullSquare,r.kOpenTriangleUp,r.kOpenCircle,r.kFullCircle,r.kOpenSquare,r.kFullSquare,r.kOpenTriangleUp]
...
def Make1DGraphs(name,outdir,histos,colors,markers,legends,oFext,xtitle="",ytitle="",
                 ...
                 xlimits=[],runNumber="",additionalText=[],LogY=False,
                 addLine=[]):
    ...
    for ih in range(len(histos)):
        ...
        if ih==0:
            ...
            histos[ih].GetYaxis().SetTitleSize(0.07)
    ...
    #BuildLegend(legends,can,histos,0.55,0.9,0.8,0.75)
    if (len(txtLocation)==0):
        InsertText(runNumber,additionalText,0.8,xoffset=minX)
    elif(len(txtLocation)==1):
        InsertText(runNumber,additionalText,txtLocation[0],xoffset=0.7)
    else:
        InsertText(runNumber,additionalText,txtLocation[0],xoffset=txtLocation[1])
