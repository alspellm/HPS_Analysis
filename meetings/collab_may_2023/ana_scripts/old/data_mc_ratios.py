...
for i,name in enumerate(mc_gbl_plots1d):
    print(name)
    cname = 'ratios_mc_data_comp_'+name.replace('vtxana_gbl_Tight_','')
    ...
    #ratio plots
    ratioPairs = [(1,0),(3,2)]
    ratioNames = ["GBL: Data_over_TritrigMC ","KF Data_over_TritrigMC"]
    utils.makeRatioPlot(plots,ratioPairs,ratioNames,"ratios_"+cname, '/home/alic/HPS/projects/simp_analysis/scripts/plots/images/test')
