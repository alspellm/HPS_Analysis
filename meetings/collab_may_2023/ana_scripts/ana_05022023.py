...
outfile = r.TFile('data_mc_z_distr_05072023.root',"RECREATE")
...
dataPlots2D["data_z0_v_reconz_hh"].GetZaxis().SetRangeUser(0.0,700000.0)
...
#dataPlots2D["data_z0_v_reconz_pos_top_hh"] = r.TH2F("data_pos_z0_v_reconz_top_hh","data_pos_z0_v_reconz_top;recon_z [mm];z0 [mm]",1100,-30.0,80.0,800,-4.0,4.0)
...
#dataPlots2D["data_z0_v_reconz_pos_bot_hh"] = r.TH2F("data_pos_z0_v_reconz_bot_hh","data_pos_z0_v_reconz_bot;recon_z [mm];z0 [mm]",1100,-30.0,80.0,800,-4.0,4.0)
...
dataPlots2D["data_reconz_invMass_hh"].GetZaxis().SetRangeUser(0.0,30000.0)
...
mcPlots2D["mc_z0_v_reconz_hh"].GetZaxis().SetRangeUser(0.0,700000.0)
...
#mcPlots2D["mc_z0_v_reconz_pos_top_hh"] = r.TH2F("mc_pos_z0_v_reconz_top_hh","mc_pos_z0_v_reconz_top;recon_z [mm];z0 [mm]",1100,-30.0,80.0,800,-4.0,4.0)
...
#mcPlots2D["mc_z0_v_reconz_pos_bot_hh"] = r.TH2F("mc_pos_z0_v_reconz_bot_hh","mc_pos_z0_v_reconz_bot;recon_z [mm];z0 [mm]",1100,-30.0,80.0,800,-4.0,4.0)
...
mcPlots2D["mc_reconz_invMass_hh"].GetZaxis().SetRangeUser(0.0,30000.0)

#####################################################################
print("Length of data: ", len(df))
print("Length of wabs: ", len(wdf))
print("Length of scaled wabs: ", len(wdf)*mcScale['wab'])
print("Length of tritrig: ", len(tdf))
print("Length of tritrig scaled: ", len(tdf)*mcScale['tritrig'])
print("Length of tritrig + wab scaled: ", len(wdf)*mcScale['wab'] + len(tdf)*mcScale['tritrig'])
