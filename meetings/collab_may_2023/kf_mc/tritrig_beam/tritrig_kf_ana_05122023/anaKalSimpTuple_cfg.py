...
recoana_kf.parameters["vtxSelectionjson"] = '/sdf/group/hps/users/alspellm/run/mc/tritrig_beam/kf_ana_05012023/vertexSelection_2016_simp_reach.json' 
...
RegionPath='/sdf/group/hps/users/alspellm/run/mc/tritrig_beam/kf_ana_05012023/'
