...
recoana_kf.parameters["vtxSelectionjson"] = '/sdf/group/hps/users/alspellm/run/mc/wab_beam/wab_kf_ana_05022023/vertexSelection_2016_simp_reach.json' 
...
RegionPath='/sdf/group/hps/users/alspellm/run/mc/wab_beam/wab_kf_ana_05022023/'
recoana_kf.parameters["regionDefinitions"] = [RegionPath+'Tight_2016_simp_reach_dev.json',
                                              RegionPath+'Tight_2016_simp_reach_dev_CR.json',
                                              RegionPath+'radMatchTight_2016_simp_reach_dev.json',
                                              RegionPath+'radMatchTight_2016_simp_reach_dev_CR.json']
