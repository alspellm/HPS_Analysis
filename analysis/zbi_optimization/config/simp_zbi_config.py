...
base.parser.add_argument("-newVariables", "--newVariables", type=str, dest="newVariables",
        help="List of new variables, strings defined in processor addNewVariables", default=[], nargs='*')

base.parser.add_argument("-newVariableParams", "--newVariableParams", type=float, dest="newVariableParams", help="New variable parameters", default=[], nargs='*')

base.parser.add_argument("-cutVariables", "--cutVariables", type=str, dest="cutVariables",
...
base.parser.add_argument("-cutsJson", type=str, dest="cutsJson",
            help="Choose json cuts file", default='/sdf/group/hps/users/alspellm/projects/THESIS/analysis/tight_selection_studies/v0_projection/zbi_opt/config/cuts_dir/iterativeCuts.json')
...
def chooseIterativeCutVariables(zbi, cutVariables = [], new_variables = [], variable_params = []):
    zbi.parameters['cutVariables'] = cutVariables
    zbi.parameters['add_new_variables'] = new_variables
...
zbi.parameters['max_iteration'] = 50
...
zbi.parameters['cuts_cfgFile'] = options.cutsJson
...
chooseIterativeCutVariables(zbi, options.cutVariables, options.newVariables, options.newVariableParams)
