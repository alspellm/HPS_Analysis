...
mkdir -p ${rundir}/logs
mkdir -p ${rundir}/bkg_models

# Path to your Python script
python_script="/sdf/group/hps/users/alspellm/projects/THESIS/analysis/zbi_optimization/plot_scripts/make_background_model_plots.py"
...
python3 ${python_script} --infileName ${input_file} --plotsDir ${rundir}/bkg_models/${filename_without_extension}
