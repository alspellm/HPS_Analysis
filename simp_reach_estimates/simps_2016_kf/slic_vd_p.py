...
index = 0
for f in sorted(glob.glob('/sdf/group/hps/users/alspellm/projects/THESIS/mc/2016/simps/slic_ana/hadd_mass_*_simp_mcAna.root')):
    ...
    psum_h.GetYaxis().SetRangeUser(0.001,800000)
