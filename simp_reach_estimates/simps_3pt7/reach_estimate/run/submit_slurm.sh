...
export RUNDIR=${runpath}/output

mkdir -p $RUNDIR
cd $RUNDIR

python3 /sdf/group/hps/users/alspellm/projects/simps_3pt7/reach_estimate/lumiMakeExpSigSimps2021.py -o ${RUNDIR}/${outfile} 
