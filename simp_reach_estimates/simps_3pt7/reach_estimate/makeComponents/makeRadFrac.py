...
invMassHistos = {}
inFile = r.TFile("/sdf/group/hps/users/alspellm/projects/simps_3pt7/rad/rad_beam/tuple_ana/hadd_rad_beam_ana.root")
invMassHistos['rad'] = copy.deepcopy(inFile.Get("vtxana_kf_radMatchTight_2021/vtxana_kf_radMatchTight_2021_mcMass622_h"))
inFile.Close()
inFile = r.TFile("/sdf/group/hps/users/alspellm/projects/simps_3pt7/tritrig_beam/tuple_ana/CR/hadd_tritrig_beam_ana.root")
invMassHistos['tritrig'] = copy.deepcopy(inFile.Get("vtxana_kf_Tight_2021/vtxana_kf_Tight_2021_vtx_InvM_h"))
inFile.Close()
inFile = r.TFile("/sdf/group/hps/users/alspellm/projects/simps_3pt7/wab_beam/super_hadd_wab_beam_CR_ana.root")
invMassHistos['wab'] = copy.deepcopy(inFile.Get("vtxana_kf_Tight_2021/vtxana_kf_Tight_2021_vtx_InvM_h"))
inFile.Close()
