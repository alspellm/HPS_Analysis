...
mcScale['wab'] = 0.1985e12*Lumi/(1000000*9966) #pb2016
...
for mass in invMasses:
    ...
    apSimFilename = "/nfs/slac/g/hps3/users/bravo/mc/ap/dis/sim/anaMCAp%i.root"%(mass, mass)
    ...
    ttTree = ttFile.Get("vtxana_Tight_2019/vtxana_Tight_tree")
    ...
    apTree = apFile.Get("vtxana_Tight_2019/vtxana_Tight_tree")
