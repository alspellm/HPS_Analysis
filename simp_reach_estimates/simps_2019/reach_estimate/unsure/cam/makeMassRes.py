...
for mass in invMasses:
    apFilename = "~/work/hps/ana/qual/mc/coll/ap%i_anaVtx_Coll.root"%(mass)
    apFile = r.TFile(apFilename)
    #apRecoMass_h = copy.deepcopy( apFile.Get("vtxana_Tight/vtxana_Tight_vtx_InvM_h") )
    apRecoMass_h = copy.deepcopy( apFile.Get("vtxana_radMatchTight/vtxana_radMatchTight_vtx_InvM_h") )
    apRecoMass_h.SetName("vtxana_radMatchTight_vtx_InvM%i_h"%mass)
