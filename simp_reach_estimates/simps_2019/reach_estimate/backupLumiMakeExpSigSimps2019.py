...
for q, Lumi in enumerate(Lumis):
    ...
    for m_Ap in ap_invMasses:
        ...
        #vdSimZ_h = r.TH1F("vdSimZ%i_h"%m_vdI, ";true z_{vtx} [mm];MC Events", 200, -50.0, 150.0)
        ...
        #Scan zCut
        zCut = zCutScan(m_vdF, shift=-6.0)

        zCutVals.append(zCut)

        #vdSelZ_h = r.TH1F("vdSelZ%i_h"%m_vdI, ";true z_{vtx} [mm];MC Events", 200, -50.0, 150.)
        #vdSelNoZ_h = r.TH1F("vdSelNoZ%i_h"%m_vdI, ";true z_{vtx} [mm];MC Events", 200, -50.0, 150.0)
